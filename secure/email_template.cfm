                                            ...
                                            <cfelse>
                                                <div style="line-height: 24px; color: #C41E3A !important">
                                                    <cfif isEvent.recordcount GT 0>
                                                        ...
                                                        <cfif chkEvtfeeGroup EQ 0 And isEvent.ppr EQ 0>
                                                            <cfset subject = "WAITLISTED <br> #AirportName# #formattedDate# #confirm.reg#">
                                                        <cfelseif  chkEvtfeeGroup EQ 0 And isEvent.ppr EQ 1>
                                                            <cfset subject = "WAITLISTED <br> #AirportName# #formattedDate# #confirm.reg#">
                                                        <cfelseif chkEvtfeeGroup GT 0 And isEvent.ppr EQ 1>
                                                            <cfset subject = "WAITLISTED <br> #AirportName# #formattedDate# #confirm.reg#">
                                            ...
                                            <cfif confirm.confirmation EQ 1>
                                                <div style="line-height: 24px">
                                                    <cfif isEvent.recordcount GT 0>
                                                        ...
                                                        <cfelseif chkEvtfeeGroup GT 0 And isEvent.ppr EQ 1>
                                                            <cfif (isDefined('url.MarkFee') and url.MarkFee EQ 1) OR confirm.feePayment EQ 1>
                                                                
                                                                <span style="text-align: center;display: block;">Notice of Arrival Confirmation</span><br><br>

                                                                <b>Note:</b><br>

                                                                - Please note that the <cfoutput><b>(#isEvent.name#)</b></cfoutput> will be taking place from <cfoutput>#DateFormat(confirm.Arrival, "mm/dd/yyyy")#</cfoutput> to <cfoutput>#DateFormat(confirm.DEPARTURE, "mm/dd/yyyy")#</cfoutput> at <cfoutput>#iata#</cfoutput>.<br>

                                                                - Your "Confirmation Number" will service as your PPR#.  Please add this number when you file your flight plan.<br><br>
                                                ...
                                                <table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="ffffff">
                                                    <tr>
                                                        <cfif (isEvent.recordcount GT 0 AND chkEvtfeeGroup GT 0 And isEvent.ppr EQ 1) AND ( NOT isDefined("url.MarkFee") OR url.MarkFee NEQ 1) And confirm.feePayment EQ 0 AND isEvent.chargeFee EQ 1> 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><cfoutput>#reg# - #confirm.make# #confirm.model#</cfoutput></td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td align="center" style="color: #444444; font-size: 18px !important; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                                            ...
                                                            <table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="ffffff">
                                                                ...
                                                                <tr>
                                                                    <td align="right" style="padding-right: 15px"><b>Aircraft</b></td>
                                                                    <td style="padding-left: 3px"><cfoutput>#reg# - #confirm.make# #confirm.model#</cfoutput></td>
                                                                </tr>
                                                                <cfif confirm.estTotal GT 0>
                                                                    <tr>
                                                                        <td align="right" style="padding-right: 15px"><b>Estimated Fee</b></td>
